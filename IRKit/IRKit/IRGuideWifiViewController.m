...
- (void)viewDidLoad {
    ...
    self.title = @"IRKitのWi-Fiに接続";
    //IRLocalizedString(@"Connect to IRKit Wi-Fi", @"title of IRGuideWifiViewController");
        ...
        if (isAdhoc) {
            ...
            [IRHTTPClient postWifiKeys: [_self.keys morseStringRepresentation]
                ...
                if (res.statusCode == 200) {
                    ...
                    [[[UIAlertView alloc] initWithTitle: @"認識完了しました。家のWi-Fiに接続しなおしてください"
                                                message: @""
                                               delegate: nil
                                      cancelButtonTitle: @"OK"
                                      otherButtonTitles: nil] show];
                    // IRLocalizedString(@"Great! Now let's connect back to your home Wi-Fi", @"alert title after POST /wifi finished successfully")
#endif
                }
                else {
...
#ifndef TARGET_IS_EXTENSION
    [[[UIAlertView alloc] initWithTitle: @"iOS端末の設定を開いて、\"IRKitXXXX\"のような名前のWi-Fiネットワークに接続してください"
                                message: @""
                               delegate: nil
                      cancelButtonTitle: @"OK"
                      otherButtonTitles: nil] show];
    // IRLocalizedString(@"Open Settings app and connect to a Wi-Fi network named like IRKitXXXX", @"alert title when reachable")
#endif
}
...
#ifndef TARGET_IS_EXTENSION
                UIAlertView *alert = [[UIAlertView alloc] initWithTitle: @"タイムアウトしました。もう一度お試しください"
                                                                message: @""
                                                               delegate: self
                                                      cancelButtonTitle: @"OK"
                                                      otherButtonTitles: nil];
                // IRLocalizedString(@"Session expired, please restart app and try again.", @"alert title when POST /1/door returned 401")
...
#ifndef TARGET_IS_EXTENSION
        [[[UIAlertView alloc] initWithTitle: @"IRKitを発見しました"
                                    message: @""
                                   delegate: nil
                          cancelButtonTitle: @"OK"
                          otherButtonTitles: nil] show];
        // IRLocalizedString(@"New IRKit found!", @"alert title when new IRKit is found")
#endif
...
#ifndef TARGET_IS_EXTENSION
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle: @"IRKitがWi-Fiに接続できませんでした。Wi-Fiのパスワードやアクセスポイントの設定を確認してもう一度お試しください。"
                                                    message: @""
                                                   delegate: self
                                          cancelButtonTitle: @"OK"
                                          otherButtonTitles: @"よくある質問", nil];
    // IRLocalizedString(@"IRKit couldn't connect to Wi-Fi. Check Wi-Fi settings and try again", @"alert title timeout")
    // IRLocalizedString(@"Show FAQ", @"title of button to FAQ on alert in IRGuideWiFiViewController")
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    ...
    // show FAQ
    IRFAQViewController *c = [[IRFAQViewController alloc] initWithNibName: @"IRFAQViewController"
