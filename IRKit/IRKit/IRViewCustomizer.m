...
- (id)init {
    ...
    __unsafe_unretained IRViewCustomizer *_self = self;
    _viewDidLoad = ^(UIViewController *viewController) {
        ...
        if ( false
//            [viewController isKindOfClass: [IRNewSignalScene1ViewController class]] ||
...
//                 [viewController isKindOfClass: [IRGuideWifiViewController class]] ||
